  ...
  return (
    ...
    >
      <div className="mb-8 md:mb-10">
        ...
        <p className="mt-3 text-[12px] md:text-[13px] text-muted max-w-[480px] leading-relaxed">Your order will be reviewed and confirmed by SAIF STORE. No payment is processed online — we will contact you for confirmation.</p>
      </div>
      ...
      <div className="grid lg:grid-cols-12 gap-8 lg:gap-16">
        <form onSubmit={handleSubmit} className="lg:col-span-7 flex flex-col gap-6 md:gap-8">
          ...
          <div className="border border-line p-5 md:p-6 bg-cream">
            ...
            <div className="flex flex-col gap-3">
              {paymentMethods.map((pm) => (
                <label key={pm.id} className={`border p-4 cursor-pointer transition-colors min-h-[60px] flex items-center ${form.payment_method === pm.id ? 'border-ink bg-paper' : 'border-line bg-paper hover:border-ink'}`}>
          ...
          <p className="text-[11px] text-muted leading-relaxed">By placing an order, you agree that SAIF STORE will review and confirm your order manually. No card data is collected.</p>
        </form>
