      ...
      <section className="container-ecru py-24 md:py-32">
        <div className="grid gap-12 lg:grid-cols-12">
          ...
          <div className="lg:col-span-8">
            <RevealText
              as="p"
              text="ÉCRU was founded in 2019 in Copenhagen as a quiet rebuttal to the seasonal noise of fashion. We make a small number of garments each year — patterns refined rather than replaced, cloth chosen for hand and longevity, and editions numbered, never replenished."
