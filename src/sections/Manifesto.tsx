...
export default function Manifesto() {
  ...
  return (
    <section ref={root} className="py-32 md:py-48">
      <div className="container-ecru">
        <span className="eyebrow mb-10 block">— Manifesto</span>
        <p className="manifesto-text font-display text-4xl md:text-6xl lg:text-7xl tracking-ultra-tight leading-[1.05] text-ink">
